  ...
  return (
    <div className="bg-black w-screen text-black pt-[2rem] min-h-screen pb-[6rem]">
      ...
      <div className="flex flex-col items-center w-[100%] px-[1.5rem]">
        <p className="text-[2rem] font-bold mt-[2rem] mb-[2rem] text-white">Welcome, Player</p>
        ...
        <div className='w-full bg-[#83A1ED] rounded-[20px] p-[1.5rem] text-[1.25rem] font-bold'>
            <p>Games Played: <span className='font-normal'>142</span></p>
            <p>Wins: <span className='font-normal'>98</span></p>
            <p>Losses: <span className='font-normal'>44</span></p>
            <p>Winning percentage: <span className='font-normal'>60%</span></p>
            <p>Level: <span className='font-normal'>Beginer</span></p>
            <div className="w-full bg-[#D9D9D9] rounded-full h-4">
                <div className="bg-[#20BF00] h-4 rounded-full" style={{ width: '60%' }}></div>
            </div>
        </div>
