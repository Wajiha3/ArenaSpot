...
function Check_In() {
  ...
  return (
    <div className="bg-black w-screen text-white pt-4">
      ...
      <div className="space-y-4 mb-6">
        ...
        <div
          className={`w-full px-4 py-2 bg-[#2096F3] font-bold border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-black ${selectedOption === 'creditCard' ? 'bg-gray-800' : 'bg-gray-700'} cursor-pointer`}
          onClick={() => handlePaymentSelect('creditCard')}
        >
          <span className="font-bold">Pay with Credit Card</span>
        </div>
        <div
          className={`w-full px-4 py-2 bg-[#56B66B] font-bold border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-black ${selectedOption === 'applePay' ? 'bg-gray-800' : 'bg-gray-700'} cursor-pointer`}
      ...
      <div className="bg-white text-center text-black p-6 rounded-lg border border-gray-700 max-w-md mt-6 mx-auto">
        <h2 className="text-xl text-black font-semibold mb-4">Reception Payment</h2>
