  ...
  return (
    <div className="bg-black h-screen w-screen text-white pt-[2rem]">
      ...
      <div className="flex flex-col justify-center items-center w-[100%]">
        <p className="text-[2rem] font-bold mt-[2rem] mb-[5rem]">Sign Up</p>
        <form className="w-[90%] flex flex-col items-center" action="" method="post">
          <div className="flex items-center bg-[#F0F0F0] w-[90%] rounded-[20px] h-[3.5rem]">
            <img className="ml-[1rem]" width={"34px"} src="/Icons/name.png" alt="" />
            <input className="ml-[1rem] text-black text-[20px] bg-transparent placeholder-black placeholder:text-[20px] w-[63%]" type="text" placeholder="Username" required />
          </div>
          <div className="mt-[1rem] flex items-center bg-[#F0F0F0] w-[90%] rounded-[20px] h-[3.5rem]">
            <img className="ml-[1rem]" width={"34px"} src="/Icons/number.png" alt="" />
            <input className="ml-[1rem] text-black text-[20px] bg-transparent placeholder-black placeholder:text-[20px] w-[63%]" type={"number"} placeholder="Phone number" required />
          </div>
          <div className="mt-[1rem] flex items-center bg-[#F0F0F0] w-[90%] rounded-[20px] h-[3.5rem]">
            <img className="ml-[1rem]" width={"34px"} src="/Icons/email.png" alt="" />
            <input className="ml-[1rem] text-black text-[20px] bg-transparent placeholder-black placeholder:text-[20px] w-[63%]" type="email" placeholder="Email" required />
          </div>
